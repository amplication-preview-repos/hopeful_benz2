...
@InputType()
class DownloadHistoryCreateNestedManyWithoutUsersInput {
...
export { DownloadHistoryCreateNestedManyWithoutUsersInput as DownloadHistoryCreateNestedManyWithoutUsersInput };
